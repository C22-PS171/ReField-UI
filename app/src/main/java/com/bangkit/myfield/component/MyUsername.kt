...
class MyUsername : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(username: CharSequence, start: Int, count: Int, after: Int) {
                // Do nothing.
            }
            override fun onTextChanged(username: CharSequence, start: Int, before: Int, count: Int) {
                if (username.toString().isNotEmpty()) showClearButton() else hideClearButton()
            }
